...
try {
  await axios.post(`/api/${initialData?.storeId}/products/${initialData?.id}/productimages`, values);
...
try {
  setDeletingId(id)
  await axios.delete(`/api/${initialData?.storeId}/products/${initialData?.id}/productimages/${id}`);
