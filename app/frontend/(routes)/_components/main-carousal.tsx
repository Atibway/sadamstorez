          ...
          <CarouselItem key={index}>
            <Card className="overflow-hidden border-none shadow-sm">
              <CardContent className="p-0">
                ...
                <h2 className="mb-2 font-h2 text-h2 font-bold">{item.name}</h2>
                <Link href={`/frontend/product/${item.id}`}>
                
                <button className="rounded-full bg-accent px-6 py-2 font-body-md text-body-md font-medium text-white transition-colors hover:bg-accent-hover">
                  Buy Now
                </button>
                </Link>
              </div>
